...
def classify(train_pkl, test_pkl, attention=False, use_pos=False, use_role=False, reconstruction=False,
             hidden_dim=128, drop=0., num_epoch=20):
...
def test1():
    ...
    classify(train_pkl, test_pkl, attention=args.att, hidden_dim=args.hid, drop=args.drop,
             use_pos=args.pos, use_role=args.role, reconstruction=args.rec)
